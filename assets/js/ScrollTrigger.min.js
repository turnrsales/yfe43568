!(function (e, t) {
    ...
    var E =
        ((Observer.prototype.init = function init(e) {
            ...
            (te = se._dc = Se.delayedCall(c || 0.25, function onStopFunc() {
    ...
    function nc(e, t, r, n, i, o, a, s, l, c, u, f, d, p) {
        ...
        if ((d && d.seek(0), isNaN(e) || (e = +e), Va(e))) d && (e = Ne.utils.mapRange(d.scrollTrigger.start, d.scrollTrigger.end, 0, f, e)), a && X(a, r, n, !0);
            ...
            var m,
                ...
                w = (e || "0").split(" ");
            (v = J(t, s) || We),
                ((m = _t(v) || {}) && (m.left || m.top)) || "none" !== nb(v).display || ((_ = v.style.display), (v.style.display = "block"), (m = _t(v)), _ ? (v.style.display = _) : v.style.removeProperty("display")),
                (y = Db(w[0], m[n.d])),
                (x = Db(w[1] || "0", r)),
        ...
        ne =
                ...
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
                    ...
                    if (
                        ...
                        ae &&
                            ...
                            (n = Ne.core.getCache(ae)).spacer
                                ? (U = n.pinState)
                                : (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = kc(l))),
                    ...
                    if (
                                ...
                                if (ae && e && st) xb(ScrollTrigger, "scrollEnd", Pb);
                                    ...
                                    for (
                                        Ua(T) && (T = T(ke)),
                                            ...
                                            ct(S) &&
                                                ...
                                                (~S.indexOf(" ")
                                                    ? (S = (ct(T) ? T.split(" ")[0] : "") + S)
                                                    : ((_ = Db(S.substr(2), b)), (S = ct(T) ? T : (de ? Ne.utils.mapRange(0, de.duration(), de.scrollTrigger.start, de.scrollTrigger.end, B) : B) + _), (k = oe))),
                                            S = Da(S, "end", ke),
                                        ...
                                        (u = (c = kt[E]).pin) &&
                                            ...
                                            !de &&
                                            0 < c.end &&
                                            ((i = c.end - (ke._startClamp ? Math.max(0, c.start) : c.start)), ((u === oe && c.start - c._pinPush < B) || u === C) && isNaN(T) && (_ += i * (1 - c.progress)), u === ae && (w += i));
                                    if (
                                        ((B += _),
                                        (I += _),
                                        ...
                                        (i = nb(ae)),
                                            ...
                                            !y &&
                                                1 < I &&
                                                ((g = { style: (g = (me ? Fe.scrollingElement || Ue : be).style), value: g["overflow" + he.a.toUpperCase()] }),
                                    ...
                                    p &&
                                        ...
                                        (x || Oe !== ke.progress || de || le || (O && !O._initted)) &&
                                            (O && !ve && (O._initted || Oe || !1 !== O.vars.immediateRender) && O.totalProgress(de && B < -0.001 && !Oe ? Ne.utils.normalize(B, I, 0) : Oe, !0),
                        ...
                        (ke.update = function (e, t, r) {
                            if (!de || r || e) {
                                ...
                                if (
                                    ...
                                    E && ae && !Ke && !ot && st && (!d && B < u + ((u - D) / (at() - Ve)) * E ? (d = 1e-4) : 1 === d && I > u + ((u - D) / (at() - Ve)) * E && (d = 0.9999)),
                                    d !== p && ke.enabled)
                                ) {
                                    if (
                        ...
                        (ke.enable = function (e, t) {
                            ke.enabled ||
                                ((ke.enabled = !0), xb(be, "resize", Mb), me || xb(be, "scroll", Kb), Te && xb(ScrollTrigger, "refreshInit", Te), !1 !== e && ((ke.progress = Oe = 0), (R = D = Ee = Ae())), !1 !== t && ke.refresh());
                        }),
            ...
            (ScrollTrigger.config = function config(e) {
                ...
                (t && clearInterval(u)) || ((u = t) && setInterval(Jb, t)),
                    ...
                    "autoRefreshEvents" in e && (Sa(yb) || Sa(xb, e.autoRefreshEvents || "none"), (h = -1 === (e.autoRefreshEvents + "").indexOf("resize")));
            }),
            ...
            (e.onRelease = e.onGestureStart = function (e, t) {
                if ((b.offset && Kq(), t)) {
                    ...
                    var r,
                        n,
                        i = w();
                    f && ((n = (r = m()) + (0.05 * i * -e.velocityX) / 0.227), (i *= uc(m, r, n, Ra(p, He))), (a.vars.scrollX = k(n))),
