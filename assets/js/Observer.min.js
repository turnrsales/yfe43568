!(function (e, t) {
    ...
    function E(n, r) {
        function qa(e) {
            if (e || 0 === e) {
                ...
                (e = qa.v = Math.round(e) || (qe && qe.iOS ? 1 : 0)), n(e), (qa.cacheID = a._scrollers.cache), t && i("ss", e);
        ...
        return {
            ...
            getVelocity: function getVelocity(e) {
                var t = a,
                    n = s,
                    r = Se();
                return (!e && 0 !== e) || e === i || Pa(e), c === a || l < r - a ? 0 : ((i + (o ? n : -n)) / ((o ? r : c) - t)) * 1e3;
            },
        };
    }
    function K(e, t) {
    ...
    var c =
        ((Observer.prototype.init = function init(e) {
            Pe || N(Me) || console.warn("Please gsap.registerPlugin(Observer)"), Xe || M();
            var o = e.tolerance,
                s = e.dragMinimum,
                t = e.type,
                i = e.target,
            ...
            function sc() {
                ...
                O && (n || r) && O(ce, e, t, _e, xe),
                    n && (x && 0 < ce.deltaX && x(ce), m && ce.deltaX < 0 && m(ce), P && P(ce), Y && ce.deltaX < 0 != ae < 0 && Y(ce), (ae = ce.deltaX), (_e[0] = _e[1] = _e[2] = 0)),
                    r && (w && 0 < ce.deltaY && w(ce), b && ce.deltaY < 0 && b(ce), E && E(ce), X && ce.deltaY < 0 != le < 0 && X(ce), (le = ce.deltaY), (xe[0] = xe[1] = xe[2] = 0)),
            ...
            function tc(e, t, n) {
                (_e[n] += e), (xe[n] += t), ce._vx.update(e), ce._vy.update(t), r ? (ee = ee || requestAnimationFrame(sc)) : sc();
            }
            function uc(e, t) {
            ...
            function vc(e) {
                if (!qc(e, 1)) {
                    var t = (e = K(e, c)).clientX,
                        ...
                        o = n - ce.y,
                        i = ce.isDragging;
                    (ce.x = t), (ce.y = n), (i || Math.abs(ce.startX - t) >= s || Math.abs(ce.startY - n) >= s) && (v && (ne = !0), i || (ce.isDragging = !0), uc(r, o), i || (g && g(ce)));
                }
            }
            function yc(e) {
            ...
            var ee,
                ...
                ge = fe(),
                pe = de(),
                ve = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Te[0],
                he = y(i),
                                ...
                                Me.delayedCall(0.08, function () {
                                    if (300 < Se() - me && !t.defaultPrevented)
                                        if (t.target.click) t.target.click();
                                            ...
                                            e.initMouseEvent("click", !0, !0, Ae, 1, o.screenX, o.screenY, o.clientX, o.clientY, !1, !1, !1, !1, 0, null), t.target.dispatchEvent(e);
                                        }
                                })),
            ...
            (te = ce._dc = Me.delayedCall(l || 0.25, function onStopFunc() {
                ...
                (ce.disable = function () {
                    ce.isEnabled &&
                        ...
                        ce.isPressed && (ce._vx.reset(), ce._vy.reset(), A(S ? i : ye, Te[1], vc, !0)),
